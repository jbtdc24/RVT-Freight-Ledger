  ...
  return (
    <div className={cn("grid gap-2", className)}>
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="max-w-none w-auto p-0 rounded-xl overflow-hidden scale-110">
          <div className="flex divide-x divide-border">
            {/* Sidebar */}
            <div className="w-[180px] p-4 flex flex-col gap-1 bg-muted/30">
              {presets.map((p) => (
                <button
                  key={p.label}
            ...
            <div className="p-8">
              ...
              <div className="mt-8 pt-6 border-t border-border flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <input
                    type="text"
                    className="bg-background border border-input rounded-md px-4 py-2 text-[13px] text-foreground font-mono w-[120px] text-center focus:outline-none focus:border-primary/50 transition-colors placeholder:text-muted-foreground"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Button
                    className="h-10 px-8 rounded-md text-[13px] font-bold"
                    onClick={handleApply}
                  >
                    Apply dates
                  </Button>
